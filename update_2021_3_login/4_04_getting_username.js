...
function on_submit_button_click(prevent){
    ...
    // Variable (declare, allocate)
    const user_name=login_input.value;
    // Varaible (check)
    console.log(user_name);
    // <form id="login-form">...</form> add .hidden{display:hidden;}
    login_form.classList.add(hidden_classname);
    // <h1 id="greeting">...</h1> remove .hidden{display:hidden;}
    greeting.classList.remove(hidden_classname);
    // Modify greeting.innerHTMl from 0 to "Hello, "+user_name
